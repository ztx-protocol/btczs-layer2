...
pub const BITCOINZ_MAINNET_FIRST_BLOCK_HEIGHT: u64 = 1;
pub const BITCOINZ_MAINNET_FIRST_BLOCK_TIMESTAMP: u32 = 1478403829; // BitcoinZ genesis timestamp
pub const BITCOINZ_MAINNET_FIRST_BLOCK_HASH: &str =
    "00040fe8ec8471911baa1db1266ea15dd06b4a8a5c453883c000b031973dce08"; // BitcoinZ genesis hash
pub const BITCOINZ_MAINNET_INITIAL_REWARD_START_BLOCK: u64 = 1;

pub const BITCOINZ_TESTNET_FIRST_BLOCK_HEIGHT: u64 = 1;
pub const BITCOINZ_TESTNET_FIRST_BLOCK_TIMESTAMP: u32 = 1478403829;
pub const BITCOINZ_TESTNET_FIRST_BLOCK_HASH: &str =
    "00040fe8ec8471911baa1db1266ea15dd06b4a8a5c453883c000b031973dce08"; // Same as mainnet for now

pub const BITCOINZ_REGTEST_FIRST_BLOCK_HEIGHT: u64 = 0;
pub const BITCOINZ_REGTEST_FIRST_BLOCK_TIMESTAMP: u32 = 0;
pub const BITCOINZ_REGTEST_FIRST_BLOCK_HASH: &str =
    "0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"; // Bitcoin regtest genesis
