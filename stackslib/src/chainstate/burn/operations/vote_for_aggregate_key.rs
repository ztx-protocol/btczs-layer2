...
impl VoteForAggregateKeyOp {
    ...
    pub fn get_sender_pubkey(tx: &BurnchainTransaction) -> Result<Secp256k1PublicKey, op_error> {
        match tx {
            ...
            BurnchainTransaction::BitcoinZ(_btcz) => {
                // For now, BitcoinZ transactions don't support this operation
                // TODO: Implement BitcoinZ transaction input parsing when needed
                Err(op_error::InvalidInput)
            },
        }
    }
